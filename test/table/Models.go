...
func (s Models) Columns() []string {
	return []string{}
}

func (s Models) Values() []any {
	return []any{}
}

func (s ModelsSchema) Table() migrator.Entity {
	return s.table
}

func (s ModelsSchema) ParseInsert() []migrator.Fields {
...
func (s ModelsSchema) ParseUpdate() []migrator.Fields {
	return migrator.GenerateSchema(s.table, migrator.UPDATE)
}

func (s ModelsSchema) ParseDelete() []migrator.Fields {
